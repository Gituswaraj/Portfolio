...
export const ScrollStackItem = ({ children, itemClassName = '', style = {} }) => (
    <div
        className={`scroll-stack-card relative w-full min-h-[400px] my-8 p-8 md:p-12 rounded-[40px] shadow-[0_10px_50px_rgba(0,0,0,0.1)] box-border origin-top transition-colors ${itemClassName}`.trim()}
        style={{
