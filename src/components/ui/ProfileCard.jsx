            ...
            <div ref={shellRef} className="relative z-[1] group">
                ...
                >
                    ...
                    >
                        ...
                        {/* Avatar content */}
                        <div
                            className="overflow-visible backface-hidden h-full w-full relative"
                            style={{
                        ...
                        >
                            <img
                                className="w-full h-full absolute left-1/2 bottom-[-1px] backface-hidden will-change-transform transition-transform duration-[120ms] ease-out object-cover"
                                src={avatarUrl}
